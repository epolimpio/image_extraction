...
def main(*args):
    ...
    n_frameslst = [31, 40]
    dtlst = [2.0/3, 0.5]  # time between frames in hours
    dxlst = [0.67, 0.67]  # XY resolution in microns
    dzlst = [10, 1]       # Z resolution in microns

    datelst = ['2015_8_26_15_56_12','2015_8_27_10_8_37']
    labels = ['Uninfected', 'Infected non-rotating']
